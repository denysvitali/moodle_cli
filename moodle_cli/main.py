...
def main():
	...
	try:
		downloader = moodle_cli.MoodleCourseDownloader(save_dir=args.base_dir, base_url=args.base_url, keep_old_files=not args.force)
		courses = downloader.extract_course_pages()
		print(courses)
		downloader.extract_and_download(courses)
